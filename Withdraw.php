        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover box-icon">
                        <a href="../LoanManagement.php" class="nav-link text-left" role="button">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center mb-4" style="justify-content:center;">
                                    <h1 class="h3 mb-0" style="text-align: center;">Withdraw Money</h1>
                                </div>
                                                ...
                                                <div style="margin-left: 15%; margin-right: 15%;">
                                                    <div class="input-group mt-5">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="inputGroup-sizing-default"><i class='bx bx-left-arrow-alt' style='color:#ff2d30'></i></span>
                                                        </div>
                                                        <input type="text" id="AccountNo" class="form-control" aria-label="Default" placeholder="Enter Customer's Account Number" aria-describedby="inputGroup-sizing-default">
                                                    ...
                                                    <div id="Deposit" class="d-grid gap-2 mt-5 col-10 mx-auto">
                                                        ...
                                                        <button type="button" style="margin-top: 5%; margin-bottom: 15%;" class="btn btn-info btn-lg btn-block">Withdraw</button>
