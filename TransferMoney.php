    ...
    <div id="wrapper">
        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <img src="../assets/img/lg-1328.png" alt="" width="24px;" class="img-fluid"><span class="align-middle"> S S</span>
                </a>
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover box-icon">
                        <a href="../admin/LoanManagement.php" class="nav-link text-left" role="button">
                            <i class="flaticon-bar-chart-1"></i> <i class="bx bx-check-circle ico"></i> Loan Management</span>
                        </a>
                    </li>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center mb-4" style="justify-content:center;">
                                    <h1 class="h3 mb-0" style="text-align: center;">Transfer Money</h1>
                                </div>
                                                ...
                                                <div style="margin-left: 15%; margin-right: 15%;">
                                                    <div class="input-group mt-5">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text " id="inputGroup-sizing-default"><i class='bx bx-left-arrow-alt' style='color:#ff203a'></i></span>
                                                        </div>
                                                        
                                                        <input type="text" id="SenderAc" class="form-control " aria-label="Default" placeholder="Enter Sender's Account Number" aria-describedby="inputGroup-sizing-default">
                                                    </div>
                                                    ...
                                                    <div class="input-group mt-5">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text " id="inputGroup-sizing-default"><i class='bx bx-right-arrow-alt' style='color:#01be32'></i></span>
                                                        </div>
                                                        <input type="text" id="ReceiverAc" class="form-control " aria-label="Default" placeholder="Enter Receiver's Account Number" aria-describedby="inputGroup-sizing-default">
                                                    </div>
                                                    ...
                                                    <div class="input-group mb-1 mt-5">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="inputGroup-sizing-default"><i class='bx bx-dollar'></i></span>
                                                        </div>
                                                        <input id="Amount" type="tel" class="form-control" aria-label="Default" placeholder="Enter Amount" aria-describedby="inputGroup-sizing-default">
                                                    ...
                                                    <div id="TransactionBtn" class="d-grid gap-2 mt-5 col-10 mx-auto">
                                                        ...
                                                        <button type="button" style="margin-top: 5%; margin-bottom: 15%;" class="btn btn-success btn-md btn-block">Transfer</button>
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            <div class="col-6 text-left">
                                <p class="mb-0">
                                <a href="../index.php" class="text-muted light">&copy<strong> Sajilo Sahakari
                                        </strong> - Developed by Milan And Niroj</a>
                                </p>
                            </div>
