				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT p.*,l.ref_no,concat(b.C_Last_Name,', ',b.C_First_Name,' ',b.C_Last_Name)as name, b.C_Mobile_No, b.C_Pincode from payments p inner join loan_list l on l.id = p.loan_id inner join customer_detail b on b.C_No = l.borrower_id  order by p.id asc");
